...
/// Renders terms & conditions as a single continuous "document".
///
/// Format per item:
/// title
///   description
///   link
class TermsAndConditionsDocument extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        for (final term in terms) ...[
          _TermsAndConditionsItem(term: term),
...
class _TermsAndConditionsItem extends StatelessWidget {
